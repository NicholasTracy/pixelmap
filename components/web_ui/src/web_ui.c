...
static const char *LOGIN_HTML =
    ...
    "<title>PixelMap Login</title><link rel=icon href=/logo.png type=image/png><style>"
    ...
    ".brand img{width:5rem;height:5rem}h1{font-size:1.25rem;margin:0}p{color:#9aa0a6;font-size:.9rem;margin:0 0 1rem}"
    ...
    "</style></head><body><div class=card><div class=brand><img src=/logo.png alt=\"\"><h1>PixelMap</h1></div>"
...
static const char *SETUP_HTML =
    "<!DOCTYPE html><html><head><meta charset=utf-8><meta name=viewport content=\"width=device-width,initial-scale=1\">"
    "<title>PixelMap Setup</title><link rel=icon href=/logo.png type=image/png><style>"
    ...
    ".brand img{width:5rem;height:5rem}h1{font-size:1.35rem;margin:0}"
    ...
    "<div class=brand><img src=/logo.png alt=\"\"><h1>PixelMap setup</h1></div>"
...
static esp_err_t h_logo_png(httpd_req_t *req)
{
    httpd_resp_set_type(req, "image/png");
    httpd_resp_set_hdr(req, "Cache-Control", "public, max-age=86400");
    return httpd_resp_send(req, (const char *)pixelmap_logo_png_start,
...
esp_err_t pm_web_ui_start(const pm_web_ui_hooks_t *hooks)
{
    ...
    const httpd_uri_t routes[] = {
        ...
        {.uri = "/logo.png", .method = HTTP_GET, .handler = h_logo_png},
